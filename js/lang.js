...
const dict = {
  en: {
    ...
    order_intro:
      "Sign in with your Mission Rush account first. Your website order will be connected to your account and can sync with Mission Rush order history.",
    auth_required_label: "Account required",
    auth_title: "Sign in before ordering",
    auth_intro:
      "Use your Mission Rush account so the order can be linked to your profile, wallet, payment, address book, and order history.",
    auth_signed_in_label: "Signed in",
    auth_sign_out: "Sign out",
    auth_login_tab: "Log in",
    auth_register_tab: "Register",
    auth_account_label: "Email or phone",
    auth_account_placeholder: "Email or phone number",
    ...
    order_details_title: "Delivery request",
    order_sync_badge: "Synced to Mission Rush account",
  ...
  zh: {
    ...
    order_intro:
      "请先使用 Mission Rush 账号登录。网页登录后创建的订单会绑定到账户，并可与 Mission Rush App 订单记录同步。",
    auth_required_label: "需要账号",
    auth_title: "下单前请先登录",
    auth_intro:
      "使用 Mission Rush 账号登录后，订单可以绑定到用户资料、钱包、支付、地址簿和订单记录。",
    auth_signed_in_label: "已登录",
    auth_sign_out: "退出登录",
    auth_login_tab: "登录",
    auth_register_tab: "注册",
    auth_account_label: "邮箱或手机号",
    auth_account_placeholder: "请输入邮箱或手机号",
    auth_password_label: "密码",
    auth_password_placeholder: "请输入密码",
    auth_login_btn: "登录",
    auth_name_label: "姓名",
    auth_name_placeholder: "请输入姓名",
    auth_phone_label: "电话",
    auth_phone_placeholder: "请输入联系电话",
    auth_email_label: "邮箱",
    ...
    order_details_label: "订单信息",
    order_details_title: "配送请求",
    order_sync_badge: "同步到 Mission Rush 账号",
